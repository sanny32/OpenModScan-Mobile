  ...
  List<Widget> _sectionChildren(
    ...
    return switch (section) {
      ...
      _SettingsSection.networkScanner => [
        ...
        _navTile(
          icon: Icons.timer_outlined,
          label: l10n.settingsScanConnectTimeout,
          value: l10n.settingsValueMs(_s.scanConnectTimeout),
          onTap: () => showSettingNumberSheet(
            context,
            title: l10n.settingsScanConnectTimeout,
            initialValue: _s.scanConnectTimeout,
            min: 50,
            max: 10000,
            onSubmitted: widget.controller.setScanConnectTimeout,
          ),
        ),
        _divider(),
        _navTile(
          icon: Icons.bolt_outlined,
          label: l10n.settingsScanConcurrency,
          value: '${_s.scanConcurrency}',
          onTap: () => showSettingNumberSheet(
            context,
            title: l10n.settingsScanConcurrency,
            initialValue: _s.scanConcurrency,
            min: 1,
            max: 256,
            onSubmitted: widget.controller.setScanConcurrency,
          ),
        ),
        _divider(),
        _toggleTile(
